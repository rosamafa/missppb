...
$cmsBlocks = array(
    array(
        'title'         => 'Home Right Top',
        'identifier'    => 'block_home_right1',
        'content'       => "<h1>Home Right One</h1>",
        'is_active'     => 1,
        'stores'        => 0
    ),
    array(
        'title'         => 'Home Left Block 1',
        'identifier'    => 'block_home_left1',
        'content'       => "<h1>Left Bar Block.</h1>",
        'is_active'     => 1,
        'stores'        => 0
    ),
    array(
        'title'         => 'Home Preface',
        'identifier'    => 'block_home_preface',
        'content'       => "<h1>Home Preface</h1>",
        'is_active'     => 1,
        'stores'        => 0
    ),
    array(
        'title'         => 'Header Top Links Right',
        'identifier'    => 'block_header_links_right',
    ...
    array(
        'title'         => 'Header Top Links Left',
        'identifier'    => 'block_header_links_top_left',
        'content'       => '<ul class="list-inline"><li><a href="mailto:info@magentosuperexpress.com"><i class="fa fa-envelope-o"></i> info@magentosuperexpress.com</a></li><li><a href="callto:+123456xxxx"><i class="fa fa-phone"></i> (+1)123-456-xxxx</a></li></ul>',
        'is_active'     => 1,
        'stores'        => 0
    ),
    array(
        'title'         => 'Footer Bottom Right Links',
        'identifier'    => 'footer-bottom-right-links',
        'content'       => '<ul class="list-inline">
                                <li><a href="#">&nbsp;<strong>Magento Themes</strong></a></li>
                                <li><a href="#">&nbsp;<strong>Responsive Themes</strong></a></li>
                                <li><a href="#">&nbsp;<strong>Magento Extensions</strong></a></li>
                            </ul>',
        'is_active'     => 1,
        'stores'        => 0
    ),
    ...
    array(
        ...
        'content'       => '<h4>Contact Info :</h4>
                            ...
                            <strong class="white">General enquiries:</strong> <a href="mailto:info@magentosuperexpress.com">info@magentosuperexpress.com</a><br />
                            <strong class="white">Support:</strong> <a href="mailto:support@magentosuperexpress.com">support@magentosuperexpress.com</a><br />
                            <strong class="white">Sales:</strong> <a href="mailto:sales@magentosuperexpress.com">sales@magentosuperexpress.com</a>
                            </p>',
        'is_active'     => 1,
        'stores'        => 0
    ),
    ...
    array(
        'title'         => 'Focus Content',
        'identifier'    => 'home-slider-below-banner',
    ...
    array(
        ...
        'title'         => 'Home Block below Product',
        'identifier'    => 'home-block2',
        'content'       => '<div class="responsive-box">
                                ...
                                <div class="responsive-features-right wow slideInRight">
                                                            <div class="right-image">
                                                                <img src="{{skin url="images/responsive-image-2.jpg"}}" align="resonsive" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
